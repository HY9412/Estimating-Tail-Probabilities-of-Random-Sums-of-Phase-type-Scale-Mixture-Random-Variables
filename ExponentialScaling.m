...
% Compare ConAK+CV and ConAK+IS+CV on exponential, ConAK+CV and ConAK+IS+CV on PH 
% Take Exponential*Erlang for example
clear all;clc;
rho=0.8;                          % parameter of geometric distribution
lambda1=3;                        % parameter of scaling distribution (exponential)
nEr = 1;   lambda2=1;             % parameter of Erlang distribution 
N1=100; N=10^5;                   
...
%% The following is ConAK algorithm + IS conditional on Erlang (PH) Exponential density
...
%% The following is ConAK algorithm + IS conditional on Erlang (PH)
